...
class MY_Model extends CI_Model {
    ...
    public function replace_into_batch($table, $data) {
        $this->insert_ignore_into_batch($table, $data);
    }
    ...
    public function insert_ignore_into_batch($table, $data) {
        ...
        //echo $sql = "INSERT IGNORE INTO " . $this->db->dbprefix($table) . " ( " . implode(", ", $column_name) . " ) VALUES " . implode(', ', $append);
        $sql =  "INSERT INTO ".$table." (".implode(', ', $column_name).") VALUES (".implode(', ', $coloumn_data).") ON DUPLICATE KEY UPDATE ".implode(', ', $update_fields);
        $this->db->query($sql);
    }
    ...
    public function getCategoryList() {
        ...
        $result = $notification_params->result_array();
