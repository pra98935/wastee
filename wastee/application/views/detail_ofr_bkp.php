            ...
            <div class="product-summary info-box">
                <div class="row">
                    <div class="col-md-5 summary-box-image">
                        <div class="img-detail-featured"><a href="#"><img ng-src="<?php echo IMAGE_UPLOADS_URL . 'product/thumb/' . $productDetail['cover_image']; ?>" 
                    ...
                    <div class="col-md-12">
                        <div class="second_row">
                            <div class="pagination" id="sly-frame" style="overflow: hidden;">
                                <ul class="item-gallery" style="transform: translateZ(0px); width: 237px;">
                                    <?php
                                    if (!empty($productImages)) {
                                        foreach ($productImages as $pImage) {
                                            ?>
                                            <li>
                                                <a href="#" data-mfp-src="<?php echo IMAGE_UPLOADS_URL . 'product/thumb/' . $pImage['media_name']; ?>" class="item-gallery-item">
                                                    <img onerror="this.onerror=null;__shpock_header.handleImage404(this);" src="<?php echo IMAGE_UPLOADS_URL . 'product/thumb/' . $pImage['media_name']; ?>" width="64" height="64" alt="Liquids verschiedene Sorten 3mg">
                                                </a>
                                            </li>
                                            <?php
                                        }
                        ...
                        <div class="col-md-6">
                            <div class="column">
                                ...
                                <div class="no-offers-yet">
                                    <p><a href="<?php echo base_url('login'); ?>" class="make">Be the first one to make an offer and get this item!</a></p>
                                </div>
                                <?php
                                } 
                                else {
                                                ...
                                                <ul class="dialog-wrapper">
                                                    ...
                                                    <a href="javascript:void(0);" ng-repeat="Offer in Conversation.offers">
                                                        <li class="activity-detail-li">
                                                            ...
                                                            <div class="activity">
                                                                <p ng-show="Offer.user_id == '<?php echo $this->session->userdata('user_id'); ?>'">You Offered {{Offer.price}}.</p>
                                                                <p ng-show="Offer.user_id != '<?php echo $this->session->userdata('user_id'); ?>'">{{Offer.first_name}} Offered {{Offer.price}}.</p>
