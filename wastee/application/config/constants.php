...
switch(ENVIRONMENT) 
{
	case 'development':
		...
		/** FACEBOOK ID **/
		define( 'FACEBOOK_ID'		,  '359991647443536' );

		/** GOOGLE+ ID **/
		define(	'GOOGLE_CLIENT_ID'		,	'212092829350-9g4c4r8vbvvbq50t6i0kvi6qe6rqekpl.apps.googleusercontent.com' );
		define(	'GOOGLE_API_KEY'		,	'vwUbDT7aUlK38FEFB-3_q6bt' );
...
define('ITEM_BUY', 'tbl_item_buy');
define('ENTITY_MEDIA', 'tbl_entity_media');
define('FOLLOWERS', 'tbl_followers');
define('NOTIFICATION', 'tbl_notification');
define('NOTIFICATION_TYPE', 'ms_notiofication_type');
define('MESSAGE', 'tbl_messages');
define('CONVERSATION', 'tbl_conversation');
define('ITEM_OFFERS', 'tbl_item_offers');
define('REVIEW', 'tbl_review');


define('PROJECT_NAME', 'Wastee.com');
define('AUTH_KEY', 'KEY');
...
define( 'MESSAGE_TYPE_QUESTION' ,   1 );
define( 'MESSAGE_TYPE_OFFER'    ,   2 );

define( 'ITEM_WATCHING' ,   'watching' );
define( 'ITEM_BUYING'    ,   'buying' );
define( 'ITEM_BOUGHT'    ,   'bought' );
